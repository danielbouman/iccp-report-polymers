...
\begin{Figure}
  \centerfloat
     \includegraphics[width=\linewidth]{end_to_end_distance_as_function_of_the_temperature.pdf}
 \captionof{figure}{Expectation value for the end to end distance squared as function of the temperature, for polymers with a length of 50 beads}\label{fig:end_to_end_afo_temperature}
\end{Figure}
